    ...
    public class MvxCachingFragmentCompatActivity : MvxAppCompatActivity, IFragmentCacheableActivity, IMvxFragmentHost
    {
        ...
        private void RestoreFragmentsCache()
        {
            ...
            foreach (var fragment in GetCurrentCacheableFragments())
            {
                ...
                fragmentInfo.CachedFragment = fragment as MvvmCross.Droid.Shared.Fragments.IMvxFragmentView;
            }
        }
        ...
        private Dictionary<string, Type> CreateFragmentTypesDictionary(Bundle outState)
        {
            ...
            {
                var fragment = info.CachedFragment as MvvmCross.Droid.Shared.Fragments.IMvxFragmentView;
                if (fragment == null)
                    continue;
        ...
        protected virtual void ShowFragment(string tag, int contentId, Bundle bundle, bool forceAddToBackStack = false, bool forceReplaceFragment = false)
        {
            ...
            else
            {
                ...
                fragInfo.CachedFragment = Android.Support.V4.App.Fragment.Instantiate(this, FragmentJavaName(fragInfo.FragmentType),
                    bundle) as MvvmCross.Droid.Shared.Fragments.IMvxFragmentView;
        ...
        {
            var mvxFragmentView = fragment as MvvmCross.Droid.Shared.Fragments.IMvxFragmentView;
